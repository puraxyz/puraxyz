...
The real defense comes from combining three things:

1. The concave cap means splitting gives diminishing per-identity returns
2. The minimum stake floor limits how many identities you can afford
3. Each identity bears full slashing risk independently. If one gets slashed, you lose stake on that identity regardless of your others
