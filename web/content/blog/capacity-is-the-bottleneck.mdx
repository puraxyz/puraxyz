...
Backproto applies backpressure routing to payment flows.
...
Together: Buildlog records it, Verifiable Rewards verifies it, Backproto routes payments accordingly.
