...
Backproto is deployed and verified on Base Sepolia today. Seventeen contracts across four domains (AI agents, Nostr relays, Lightning routing, demurrage), 125 passing tests, a TypeScript SDK, and a research paper with formal proofs. MIT licensed.
