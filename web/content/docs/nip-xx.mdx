...
This is a summary of the full [NIP-XX specification](https://github.com/backproto/backproto/blob/main/docs/nips/NIP-XX-backpressure-relay-economics.md).
...
The complete NIP-XX specification with all protocol details, message formats, and implementation requirements is in the [docs/nips](https://github.com/backproto/backproto/blob/main/docs/nips/NIP-XX-backpressure-relay-economics.md) directory.
