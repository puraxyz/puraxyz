...
| Router dashboard | Provided at `router.backproto.io/your-economy` | Fork the [router reference app](/docs/router) |
...
- [Smart Contracts](/docs/contracts) — all 22 contracts
